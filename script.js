document.addEventListener('DOMContentLoaded', () => {
    ...
    const POKEMON_DATA = {
        ...
        trapinch: { name: 'Trapinch', type: ['Ground'], front_img: 'https://img.pokemondb.net/sprites/black-white/anim/normal/trapinch.gif', back_img: 'https://img.pokemondb.net/sprites/black-white/anim/back-normal/trapinch.gif', evolution: { name: 'Vibrava', back_img: 'https://img.pokemondb.net/sprites/black-white/anim/back-normal/vibrava.gif', evolution: { name: 'Flygon', back_img: 'https://img.pokemondb.net/sprites/black-white/anim/back-normal/flygon.gif' }}},
        spheal: { name: 'Spheal', type: ['Ice', 'Water'], front_img: 'https://img.pokemondb.net/sprites/black-white/anim/normal/spheal.gif', back_img: 'https://img.pokemondb.net/sprites/black-white/anim/back-normal/spheal.gif', evolution: { name: 'Sealeo', back_img: 'https://img.pokemondb.net/sprites/black-white/anim/back-normal/sealeo.gif', evolution: { name: 'Walrein', back_img: 'https://img.pokemondb.net/sprites/black-white/anim/back-normal/walrein.gif' }}},
        ...
        aron: { name: 'Aron', type: ['Steel', 'Rock'], front_img: 'https://img.pokemondb.net/sprites/black-white/anim/normal/aron.gif', back_img: 'https://img.pokemondb.net/sprites/black-white/anim/back-normal/aron.gif', evolution: { name: 'Lairon', back_img: 'https://img.pokemondb.net/sprites/black-white/anim/back-normal/lairon.gif', evolution: { name: 'Aggron', back_img: 'https://img.pokemondb.net/sprites/black-white/anim/back-normal/aggron.gif', mega: { name: 'Mega Aggron', back_img: 'https://img.pokemondb.net/sprites/xy/anim/back-normal/aggron-mega.gif' } }}},
    ...
    function checkForEvolution() {
        ...
        if (isLegendaryMode) {
            if (playerPokemonData.currentStage === 0 && evolutionCounter >= 8 && (playerPokemonData.mega || playerPokemonData.primal)) {
